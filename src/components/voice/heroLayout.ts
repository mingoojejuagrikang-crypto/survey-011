...
export const CHIP_TYPE = {
  ...
  name: 'calc(min(42cqh, max(14px, 37.25cqh + 0.5cqw)) * var(--fit-lo, 1))',
  inputValue: 'calc(min(41cqh, max(18px, 32.9cqh + 0.44cqw)) * var(--fit-hi, 1))',
  value: 'calc(min(47cqh, max(18px, 41.65cqh + 0.56cqw)) * var(--fit-hi, 1))',
} as const;
